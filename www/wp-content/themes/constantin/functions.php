...
function constantin_setup() {
	...
	register_nav_menu( 'secondary', __( 'Primary Menu', 'constantin' ) );
...
require( get_template_directory() . '/inc/produtos.php' );

/********************************
****** TAMANHOS DE IMAGEM *******
*********************************/

add_image_size('home-post', 296, 172, true);
add_image_size('slide-int', 333, 564, true);
...
function constantin_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Topo (Header)', 'constantin' ),
		'id' => 'sidebar-1',
